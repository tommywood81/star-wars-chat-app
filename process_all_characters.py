#!/usr/bin/env python3
"""
Process all Star Wars dialogue and normalize character names.
Focus on top 30 characters by dialogue count.
"""
...
class CharacterProcessor:
    def __init__(self):
        ...
        # Comprehensive character name mappings
        ...
        try:
            ...
            for line in lines:
                ...
                if (line.isupper() and len(line) > 2 and 
                    line not in ['INT.', 'EXT.', 'FADE', 'CUT', 'DISSOLVE', 'CONTINUED']):
            ...
            logger.info(f"📝 Extracted {len(dialogue_lines)} lines from {script_path.name}")
...
async def main():
    logger.info("🌟 Processing All Star Wars Characters")
    logger.info("=" * 50)
    ...
    try:
        ...
        logger.info("🎉 All character processing completed!")
